  ...
  return (
    <div>
      <section
        ...
        id="home"
        style={{ backgroundImage: `url(${optOT.src})`, backgroundSize: "cover", backgroundRepeat: "no-repeat" }}
      >
        <div
        ...
        >
          ...
          >
            <h2 className="text-secondaryColor text-sm sm:text-lg  mb-6 sm:mt-24 mt-12 p-10 pl-20 font-bold uppercase backdrop-blur-lg rounded-lg" style={{ backgroundColor: "#4D734F30" }}>
              THE BEST PHYSICAL THERAPIST IN CENTENNIAL / HIGHLANDS RANCH, CO.
            </h2>
          </motion.div>
          <motion.div
            initial={{ opacity: 0, y: 10 }}
          ...
          >
            <div className="md:w-1/2 xl:w-2/5 text-5xl sm:text-4xl lg:text-4xl xl:text-4xl font-bold tracking-wide font-NotoSerif uppercase text-primaryText sm:px-8 md:px-20 lg:px-20">
              <h1>Bridging the gap between physical therapy and sports performance:
          ...
          >
            <h2 className="text-secondaryText text-sm lg:text-base xl:text-lg sm:text-base mt-10 px-12 sm:px-20 ">
          ...
          <div className="relative w-screen flex justify-center ">
            <div className="shape-divider-bottom-1665343298 mt-4 sm:mt-8 md:mt-64 lg:mt-60 xl:mt-80 hidden lg:block">
              <svg
                data-name="Layer 1"
      ...
      <section
        ...
        id="home"
        style={{ backgroundImage: `url(${optOT.src})`, backgroundSize: "cover", backgroundRepeat: "no-repeat", backgroundPosition: "center", }}
      >
        <div
        ...
        >
          <motion.div
            ...
            transition={{ duration: 0.5 }}
          >
            <h2 className="w-full text-secondaryColor text-center text-xl mt-[125px] p-10 font-bold uppercase backdrop-blur-lg" style={{ backgroundColor: "#4D734F30" }}>
              THE BEST PHYSICAL THERAPIST IN CENTENNIAL / HIGHLANDS RANCH, CO.
            </h2>
          </motion.div>
          <motion.div
            ...
            transition={{ duration: 0.5, delay: 0.05 }}
          >
            <div className="w-full text-center text-primaryText py-12">
              <h1 className="font-bold text-2xl tracking-wide font-NotoSerif uppercase mx-5">Bridging the gap between physical therapy and sports performance:
                We help people feel better, and stay better.
              </h1>
              ...
              <button
                className="contained-button h-16 m-20 p-10"
                onClick={() => setIsModalOpen(true)}
                aria-label="Get started"
              >
                BOOK A FREE CONSULTATION
