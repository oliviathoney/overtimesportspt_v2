        ...
        <section className="w-screen justify-center lg:justify-normal flex bg-gradient-to-b to-bgDark1 from-primaryColor relative">
            ...
            >
                ...
                <div className="w-screen flex flex-col gap-10 lg:flex-row items-center lg:items-normal">
                    ...
                    >
                        <div className="block-subtitle text-center lg:text-start mb-6 bg-[#26272B40] py-5 rounded-md lg:px-5">GET STARTED AT THE BEST PHYSICAL THERAPY FACILITY IN CENTENNIAL, CO.
                        </div>
                        <div className="block-big-title text-center lg:text-start lg:mb-5 font-NotoSerif">
                    ...
                    >
                        <button
                            className="contained-button-reverse w-1/4 sm:w-full h-12 mr-0 mb-5 lg:mb-auto"
